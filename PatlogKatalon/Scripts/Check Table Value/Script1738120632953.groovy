...
WebUI.verifyElementPresent(findTestObject('Page Values/row 1'), 2)

row1 = WebUI.getText(findTestObject('Page Values/row 1'))

WebUI.verifyEqual(row1, '27.806,00', FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Page Values/row 2'), 2)

row2 = WebUI.getText(findTestObject('Page Values/row 2'))

WebUI.verifyEqual(row2, '10.958,00', FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Page Values/row 3'), 2)

row3 = WebUI.getText(findTestObject('Page Values/row 3'))

WebUI.verifyEqual(row3, '4.950,52', FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Page Values/row 4'), 2)

row4 = WebUI.getText(findTestObject('Page Values/row 4'))

WebUI.verifyEqual(row4, '4.339,44', FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Page Values/row 5'), 2)

row5 = WebUI.getText(findTestObject('Page Values/row 5'))

WebUI.verifyEqual(row5, '3.968,00', FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementClickable(findTestObject('Page Values/next page button'))

WebUI.click(findTestObject('Page Values/next page button'))
